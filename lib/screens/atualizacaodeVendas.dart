...
class _AtualizacaodeVendasState extends State<AtualizacaodeVendas> {
  ...
  Future<void> _AtualizarProdutosVendas() async {
    ...
    await FirebaseFirestore.instance.collection('Vendas').doc(widget.document.id).update({
          ...
          children: [
            TextField(
              ...
              decoration: InputDecoration(
                hintText: nomeCliente!.text.isNotEmpty ? nomeCliente?.text : 'Nome do Cliente',
                ...
                itemBuilder: (context, index){
                  ...
                  return Column(
                    ...
                    children: [
                      Text('ID do Produto:'),
                      TextField(
                        controller: TextEditingController(text: produto['idProduto']),
                        onChanged: (value) {
                      ...
                      TextField(
                        controller: TextEditingController(text: produto['nomeProd']),
                        onChanged: (value) {
